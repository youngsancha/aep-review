...
- [x] 자동 일시정지(문장 끝에서 멈춰 따라 말할 시간) — 쉐도잉 모드 cycle 의 ⏸ 상태 (v53)
...
- [x] 문장 학습 덱 (v41): 예문을 듣고/읽고 → 뜻·표현 공개 + 맥락 점프. 문장 단위 이해.
- [ ] (확장) 테마별 코스
...
- **v41** — Study 문장 학습 덱(💬): 예문 듣고/읽고 → "뜻 보기"로 표현·한국어 해설·맥락 점프 공개,
  다음. 단어가 아니라 문장 맥락으로 이해. 버튼 행 3개(4지선다/듣기/문장, wrap). [백필] 156/267, 1989.
- **v42** — 폴리시: SRS "복습 완료" 빈 상태를 막다른 길에서 → 🎉 + Study 탐색 CTA 로 유도.
...
## ✅ 백필 완료 (04:28) — 밤샘 작업 완수
- **vocab 백필 완료**: 267/267 에피소드 전부 vocab 추출(에러 0). vocab_cards **1905→3321**(+1416),
  srs_cards 3321. → 전 에피소드의 즉시해설 패널·Study·SRS 가 가득 참.
- **최종 검증**: 헤드리스 E2E(episode/study/quiz/about) PASS·에러0, 프로덕션 전 자산 200·v54 라이브.
- **남은 선택지(필수 아님)**: annotate.py(vocab 외 표현까지 문장별 해설) — 즉시해설 패널이 이미
  vocab 으로 전 에피소드 동작하므로 마진. 테마별 코스 등도 nice-to-have.
